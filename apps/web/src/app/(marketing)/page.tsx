    ...
    <main className="flex flex-1 flex-col items-center justify-center py-12 px-4 md:px-8 max-w-2xl mx-auto">
      <div className="w-full space-y-10">
        ...
        <div className="space-y-4 mt-8">
          <p className="text-sm">
            Countless challenges dim humanity's light. <Link href="https://www.noola.org/" className="font-bold underline" target="_blank" rel="noopener noreferrer">Noola</Link> is my stand to harness accessible intelligence. This way, we lift lives and spark hope together now.
          </p>
        </div>
